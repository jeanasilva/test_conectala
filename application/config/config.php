...
|
*/
$prod_url = 'https://conectala.jeansilva.dev.br/';
$env_base = getenv('BASE_URL') ?: NULL;
...
|
*/
$config['log_threshold'] = 1; // Basic logging for API
...
$config['sess_save_path'] = getenv('CI_SESS_SAVE_PATH') ?: '/tmp';
...
*/
$config['csrf_protection'] = FALSE; // APIs typically manage auth via tokens
